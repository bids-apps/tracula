...
wd=/data.nfs/ds114/tracula_full_tests/${tracula_version}_fs_precomp
...
fs_dir=${data_dir}/${ds_name}_freesurfer
...
tar -zcvf ${wd}/results_tracula_${tracula_version}_fs_precomp_${ds_name}.tar.gz ${out_dir}
